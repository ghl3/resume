...
%	\vspace*{-4pt}
        ...
        \item Wrote C++ code to analyze thousands of live collissions per second to determine which should be recorded to disk % determine which  % MET Trigger
        ...
        %\item Primary developer of C++/python/xml probabilistic modeling packagecode to build a probabilistic modeling package % HistFactory
        %into a into Worked with several analysis groups to statistically combine individual measurements to produce   % ttbar cross-section combination
